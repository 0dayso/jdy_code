...
<link rel="stylesheet" type="text/css" href="{{assetUrlByCdn('/static/weixin/activity/twenty/css/index.css')}}">
@endsection
...
@endif
        ...
        <div class="page-center page-surprise">
            ...
            <img src="{{ assetUrlByCdn("/static/weixin/activity/twenty/images/prize".$lotteryInfo['lottery']['order_num'].".png") }}">
             <p>{{$lotteryInfo['lottery']['name']}}</p>
            @else

            <img src="{{ assetUrlByCdn("/static/weixin/activity/twenty/images/prize1.png") }}">
            <p>周大福 真情宝宝</p>
            @endif
        </div>
        ...
        <!-- rule -->
         <div class="page-rule">
              ...
              <p><span>3.  </span>活动期间内，所有领取的现金券或加息券仅限投资优选项目使用（1月期除外），自领取之日起有效期15天；</p>
              <p><span>4.  </span>活动期间内，每日在投资优选项目的投资者中，随机抽取一名获奖者，获得当日对应的实物奖品；中奖信息将于下一个工作日11点开奖；</p>
              <p><span>5.  </span>活动期间内，获得实物奖品者如提现金额≥10000元，则取消其领奖资格；</p>
              <p><span>6.  </span>活动所得奖品以实物形式发放，将在2017年7月30日之前，与您沟通联系确定发放奖品。如联系用户无回应，视为自动放弃活动奖励;</p>
              <p><span>7.  </span>活动期间如有任何疑问请致电九斗鱼官方客服：400-6686-568，或登录九斗鱼咨询在线客服。</p>
              <p><span>8.  </span>本活动最终解释权归九斗鱼所有。</p>
        </div>
</article>
        <!-- End rule -->
        <!-- pop  领取1%定期加息券-->
        ...
        <section class="pop-wrap cash6">
            ...
            <div class="pop">
                <span class="pop-close"></span>
                <p class="pop-text pop-pt">您还未登录</p>
