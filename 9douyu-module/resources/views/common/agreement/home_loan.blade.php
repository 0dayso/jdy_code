...
<table border="1">
	<tbody>
		...
		<tr>
			<td rowspan="<?php echo empty(count($loan_username) ) ? 1 : count($loan_username) ;?>" align="center">九省心 {{ $project['invest_time_note'] or null }} {{ $project['id'] or null }}</td>
...
<table border="1">
	<tbody>
		...
		<tr>
			<td align="center">九省心 {{ $project['invest_time_note'] or null }} {{ $project['id'] or null }}</td>
