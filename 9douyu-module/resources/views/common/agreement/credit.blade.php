...
<p>
	<span>乙方（债权出让人）：{{ $creditorInfo[0] or '池洪英' }} </span>
</p>
<p>
	<span>身份证号码：{{ $creditorInfo[1] or '110222195008065720' }}</span>
</p>
<p>
	<span></span>
</p>
...
<table border="1">
	<tbody>
		...
		<tr>
			<td rowspan="{{ $realLoanUserNum }}" align="center">九省心 {{ $project['invest_time_note'] }} {{ $project['id'] }}</td>
