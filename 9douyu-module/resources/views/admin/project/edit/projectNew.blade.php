...
@section('content')
    ...
    <!-- start: Content -->
    <form role="form" action="/admin/project/doUpdateNew" method="post">
                ...
                <div class="box-content form-horizontal">
                    <fieldset>
                            ...
                            <div class="controls">
                                <select id="productLine" name="product_line" data-rel="chosen">
                                    @foreach($productLine as $key => $title){
                                        @if (($projectInfo['product_line']+$projectInfo['type']) == $key)
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="input-prepend input-append">
                                    <input class="input-xlarge focused" id="date02" type="text" name="invest_time" value="{{ Input::old('invest_time', $projectInfo['invest_time']) }}"><span class="add-on invest_time_note"> {{$investNote}} </span>
                                </div>
                            </div>
                        </div>
                        {{--到期日期--}}
                            ...
                            @foreach($creditList as $key => $info)
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <label><input type="radio" class="input-xlarge focused" name="credit_id" {{ $checkBoxType }} value="{{$info['id']}}"></label>
                                    </td>
                                    <td>{{ $info['id'] }}</td>
